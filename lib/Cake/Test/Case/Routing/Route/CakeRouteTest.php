...
class CakeRouteTest extends CakeTestCase
{
    ...
    {
        $route = new CakeRoute(
                '/:controller/:action/:id', array (), array ('id' => Router::ID)
        );
        $result = $route->compile();
        ...
        $route = new CakeRoute(
                '/:lang/:controller/:action/:id', array ('controller' => 'testing4'), array ('id' => Router::ID, 'lang' => '[a-z]{3}')
        );
        $result = $route->compile();
        ...
        $route = new CakeRoute(
                '/posts/:id::title/:year', array ('controller' => 'posts', 'action' => 'view'), array ('id' => Router::ID, 'year' => Router::YEAR, 'title' => '[a-z-_]+')
        );
        $result = $route->compile();
        ...
        $route = new CakeRoute(
                '/posts/:url_title-(uuid::id)', array ('controller' => 'posts', 'action' => 'view'), array ('pass' => array ('id', 'url_title'), 'id' => Router::ID)
        );
        $result = $route->compile();
    ...
    {
        $route = new CakeRoute(
                '/posts/:month/:day/:year/*', array ('controller' => 'posts', 'action' => 'view'), array ('year' => Router::YEAR, 'month' => Router::MONTH, 'day' => Router::DAY)
        );
        $result = $route->compile();
        ...
        $route = new CakeRoute(
                "/:extra/page/:slug/*", array ('controller' => 'pages', 'action' => 'view', 'extra' => null), array ("extra" => '[a-z1-9_]*', "slug" => '[a-z1-9_]+', "action" => 'view')
        );
        $result = $route->compile();
        ...
        $route = new CakeRoute(
                '/:controller/:action/*', array ('project' => false), array (
    ...
    {
        $route = new CakeRoute(
                '/:lang/:color/blog/:action', array ('controller' => 'posts'), array ('persist' => array ('lang', 'color'))
        );
    ...
    public function testPersistParamsNonArray ()
    {
        ...
        $route = new CakeRoute(
                '/:lang/:color/blog/:action', array ('controller' => 'posts')
                // No persist options
        );
        $result = $route->persistParams($url, $params);
        ...
        $route = new CakeRoute(
                '/:lang/:color/blog/:action', array ('controller' => 'posts'), array ('persist' => false)
        );
        $result = $route->persistParams($url, $params);
        $this->assertEquals($url, $result);

        $route = new CakeRoute(
                '/:lang/:color/blog/:action', array ('controller' => 'posts'), array ('persist' => 'derp')
        );
        $result = $route->persistParams($url, $params);
        $this->assertEquals($url, $result);
    }
    ...
    {
        $route = new CakeRoute(
                '/:controller/:action/:id', array ('controller' => 'testing4', 'id' => null), array ('id' => Router::ID)
        );
        $route->compile();
        ...
        $route = new Cakeroute(
                '/admin/:controller', array ('prefix' => 'admin', 'admin' => 1, 'action' => 'index')
        );
        $route->compile();
    ...
    {
        $route = new Cakeroute(
                '/:controller/:slug', array ('action' => 'view')
        );
        $route->compile();
    ...
    {
        $route = new CakeRoute(
                '/blog/:action/*', array ('controller' => 'blog_posts'), array ('action' => 'other|actions')
        );
    ...
    {
        $route = new CakeRoute(
                '/:section', array ('plugin' => 'blogs', 'controller' => 'posts', 'action' => 'index'), array (
