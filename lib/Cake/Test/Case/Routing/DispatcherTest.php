...
class DispatcherTest extends CakeTestCase
{
    ...
    public function testPluginDispatch ()
    {
        ...
        $Dispatcher = new TestDispatcher();
        Router::connect(
                '/my_plugin/:controller/*', array ('plugin' => 'my_plugin', 'controller' => 'pages', 'action' => 'display')
        );
    ...
    public function testAutomaticPluginDispatch ()
    {
        ...
        $Dispatcher = new TestDispatcher();
        Router::connect(
                '/my_plugin/:controller/:action/*', array ('plugin' => 'my_plugin', 'controller' => 'pages', 'action' => 'display')
        );
