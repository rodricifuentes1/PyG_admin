...
class FormHelperTest extends CakeTestCase
{
    ...
    public function testFormInputs ()
    {
        ...
        $result = $this->Form->inputs(
                array ('foo' => array ('type' => 'text')), array (), array ('legend' => false)
        );
        $this->assertTags($result, $expected);
    }
    ...
    public function testRadioBetween ()
    {
        $result = $this->Form->radio(
                'Model.field', array ('option A', 'option B'), array ('between' => 'I am between')
        );
        $expected = array (
            'fieldset' => array (),
            'legend' => array (),
        ...
        $result = $this->Form->radio(
                'Model.field', array ('option A', 'option B', 'option C'), array ('separator' => '--separator--', 'between' => array ('between A', 'between B', 'between C'))
        );
    ...
    {
        $result = $this->Form->radio(
                'Model.field', array ('option A', 'option B'), array ('disabled' => array (0), 'value' => '0')
        );
        $expected = array (
            'fieldset' => array (),
            'legend' => array (),
        ...
        $result = $this->Form->radio(
                'Model.field', array ('option A', 'option B'), array ('disabled' => true, 'value' => '0')
        );
        $expected = array (
            'fieldset' => array (),
            'legend' => array (),
        ...
        $result = $this->Form->radio(
                'Model.field', array ('option A', 'option B'), array ('disabled' => 'disabled', 'value' => '0')
        );
        $expected = array (
            'fieldset' => array (),
            'legend' => array (),
    ...
    public function testRadioLabelArray ()
    {
        ...
        $this->assertTextContains(
                '<label for="ModelField1" class="checkbox float-left">Option A</label>', $result
        );
    }
    ...
    public function testRadioWithCreate ()
    {
        ...
        $result = $this->Form->radio('recipient', array ('1' => '1', '2' => '2', '3' => '3'), array ('legend' => false, 'value' => '1')
        );
        $this->assertTextNotContains(
                '<label for="ModelModelRecipient1">1</label>', $result
        );
        $this->assertTextContains(
                '<label for="ModelRecipient1">1</label>', $result
        );
    }
    ...
    public function testSelect ()
    {
        ...
        $result = $this->Form->select(
                'Model.field', array ('first' => 'first "html" <chars>', 'second' => 'value'), array ('empty' => false)
        );
        $expected = array (
            'select' => array ('name' => 'data[Model][field]', 'id' => 'ModelField'),
        ...
        $result = $this->Form->select(
                'Model.field', array ('first' => 'first "html" <chars>', 'second' => 'value'), array ('escape' => false, 'empty' => false)
        );
        $expected = array (
            'select' => array ('name' => 'data[Model][field]', 'id' => 'ModelField'),
            array ('option' => array ('value' => 'first')),
        ...
        $result = $this->Form->select(
                'Model.field', $options, array ('escape' => false, 'empty' => false)
        );
        $expected = array (
            'select' => array ('name' => 'data[Model][field]', 'id' => 'ModelField'),
            array ('option' => array ('value' => 'first')),
        ...
        $result = $this->Form->select(
                'Model.contact_id', array ('228' => '228 value', '228-1' => '228-1 value', '228-2' => '228-2 value'), array ('escape' => false, 'empty' => 'pick something')
        );
    ...
    {
        $result = $this->Form->select(
                'Model.field', array (1 => 'One', 2 => 'Two', 'Three' => array (
        ...
        $result = $this->Form->select(
                'Model.field', array (1 => 'One', 2 => 'Two', 'Three' => array (3 => 'Three', 4 => 'Four')), array ('showParents' => true, 'empty' => false)
        );
    ...
    {
        $result = $this->Form->select(
                'Model.multi_field', array ('first', 'second', 'third'), array ('multiple' => 'checkbox')
        );
        ...
        $result = $this->Form->select(
                'Model.multi_field', array ('a' => 'first', 'b' => 'second', 'c' => 'third'), array ('multiple' => 'checkbox')
        );
        $expected = array (
            'input' => array (
                'type' => 'hidden', 'name' => 'data[Model][multi_field]', 'value' => '', 'id' => 'ModelMultiField'
    ...
    {
        $result = $this->Form->select(
                'Model.tags', array ('first', 'second'), array ('multiple' => 'checkbox', 'class' => 'my-class')
        );
        $expected = array (
            'input' => array (
                'type' => 'hidden', 'name' => 'data[Model][tags]', 'value' => '', 'id' => 'ModelTags'
    ...
    public function testSelectMultipleCheckboxSecurity ()
    {
        ...
        $result = $this->Form->select(
                'Model.multi_field', array ('1' => 'first', '2' => 'second', '3' => 'third'), array ('multiple' => 'checkbox')
        );
    ...
    public function testSelectMultipleSecureWithNoOptions ()
    {
        ...
        $this->Form->select(
                'Model.select', array (), array ('multiple' => true)
        );
    ...
    public function testSelectNoSecureWithNoOptions ()
    {
        ...
        $this->Form->select(
                'Model.select', array (), array ('empty' => true)
        );
        $this->assertEquals(array ('Model.select'), $this->Form->fields);
    }
    ...
    {
        $result = $this->Form->select('Model.multi_field', array ('first', 'second'), array ('multiple' => 'checkbox', 'hiddenField' => false, 'value' => null)
        );
        $expected = array (
            array ('div' => array ('class' => 'checkbox')),
            array ('input' => array ('type' => 'checkbox', 'name' => 'data[Model][multi_field][]', 'value' => '0', 'id' => 'ModelMultiField0')),
    ...
    {
        $result = $this->Form->select(
                'Model.multi_field', array ('first', 'second', 'third'), array ('multiple' => 'checkbox', 'id' => 'CustomId')
        );
    ...
    public function testPostLink ()
    {
        ...
        $result = $this->Form->postLink(
                '', array ('controller' => 'items', 'action' => 'delete', 10), array ('class' => 'btn btn-danger', 'escape' => false), 'Confirm thing'
        );
        $this->assertTags($result, array (
            'form' => array (
