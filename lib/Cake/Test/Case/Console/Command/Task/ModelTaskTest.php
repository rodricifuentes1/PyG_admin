...
class ModelTaskTest extends CakeTestCase
{
    ...
    public function setUp ()
    {
        ...
        $this->Task = $this->getMock('ModelTask', array ('in', 'err', 'createFile', '_stop', '_checkUnitTest'), array ($out, $out, $in)
        );
    ...
    protected function _useMockedOut ()
    {
        ...
        $this->Task = $this->getMock('ModelTask', array ('in', 'out', 'err', 'hr', 'createFile', '_stop', '_checkUnitTest'), array ($out, $out, $in)
        );
        $this->_setupOtherMocks();
    }
    ...
    public function testGetTableOddTableInteractive ()
    {
        $out = $this->getMock('ConsoleOutput', array (), array (), '', false);
        $in = $this->getMock('ConsoleInput', array (), array (), '', false);
        $this->Task = $this->getMock('ModelTask', array ('in', 'err', '_stop', '_checkUnitTest', 'getAllTables'), array ($out, $out, $in)
        );
        $this->_setupOtherMocks();
...
TEXT;
    ...
    public function testExecuteIntoAllOddTables ()
    {
        ...
        $out = $this->getMock('ConsoleOutput', array (), array (), '', false);
        $in = $this->getMock('ConsoleInput', array (), array (), '', false);
        $this->Task = $this->getMock('ModelTask', array ('in', 'err', '_stop', '_checkUnitTest', 'getAllTables', '_getModelObject', 'doAssociations', 'doValidation', 'doActsAs', 'createFile'), array ($out, $out, $in)
        );
        $this->_setupOtherMocks();
