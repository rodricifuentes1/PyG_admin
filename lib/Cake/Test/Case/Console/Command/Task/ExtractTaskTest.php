...
class ExtractTaskTest extends CakeTestCase
{
    ...
    public function setUp ()
    {
        ...
        $this->Task = $this->getMock(
                'ExtractTask', array ('in', 'out', 'err', '_stop'), array ($out, $out, $in)
        );
    ...
    public function testExtractExcludePlugins ()
    {
        ...
        $this->Task = $this->getMock('ExtractTask', array ('_isExtractingApp', '_extractValidationMessages', 'in', 'out', 'err', 'clear', '_stop'), array ($this->out, $this->out, $this->in)
        );
    ...
    public function testExtractPlugin ()
    {
        ...
        $this->out = $this->getMock('ConsoleOutput', array (), array (), '', false);
        $this->in = $this->getMock('ConsoleInput', array (), array (), '', false);
        $this->Task = $this->getMock('ExtractTask', array ('_isExtractingApp', 'in', 'out', 'err', 'clear', '_stop'), array ($this->out, $this->out, $this->in)
        );
