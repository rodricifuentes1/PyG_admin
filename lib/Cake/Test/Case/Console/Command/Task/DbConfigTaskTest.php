...
class DbConfigTaskTest extends CakeTestCase
{
    ...
    public function setUp ()
    {
        ...
        $this->Task = $this->getMock('DbConfigTask', array ('in', 'out', 'err', 'hr', 'createFile', '_stop', '_checkUnitTest', '_verify'), array ($out, $out, $in)
        );
    ...
    public function testExecuteIntoInteractive ()
    {
        ...
        $this->Task = $this->getMock(
                'DbConfigTask', array ('in', '_stop', 'createFile', 'bake'), array ($out, $out, $in)
        );
