...
class DataSourceTest extends CakeTestCase
{
    ...
    public function setUp ()
    {
        ...
        $this->Source = $this->getMock(
                'TestSource', array ('create', 'read', 'update', 'delete')
        );
        ...
        $this->Model = $this->getMock(
                'Model', array ('getDataSource'), array (array ('ds' => $this->sourceName))
        );
    ...
    public function testCreate ()
    {
        ...
        $this->Source->expects($this->once())
                ->method('create')
                ->with(
                        $this->equalTo($this->Model), $this->equalTo(array_keys($data[$this->Model->alias])), $this->equalTo(array_values($data[$this->Model->alias]))
        );
    ...
    public function testRead ()
    {
        ...
        $this->Source->expects($this->once())
                ->method('read')
                ->with(
                        $this->anything(), $this->equalTo($expected)
        );
    ...
    public function testDelete ()
    {
        ...
        $this->Source->expects($this->once())
                ->method('delete')
                ->with(
                        $this->equalTo($this->Model), $this->equalTo(array ($this->Model->alias . '.id' => 1))
        );
        $this->Model->delete(1);
    }
