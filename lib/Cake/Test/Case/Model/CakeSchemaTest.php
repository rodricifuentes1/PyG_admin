...
class CakeSchemaTest extends CakeTestCase
{
    ...
    public function testSchemaRead ()
    {
        ...
        {
            $this->assertEquals(
                    $read['tables']['datatypes']['float_field']['length'], $this->Schema->tables['datatypes']['float_field']['length']
            );
        }

        $this->assertEquals(
                $read['tables']['datatypes']['float_field']['type'], $this->Schema->tables['datatypes']['float_field']['type']
        );

        $this->assertEquals(
                $read['tables']['datatypes']['float_field']['null'], $this->Schema->tables['datatypes']['float_field']['null']
        );
    ...
    public function testSchemaReadWithCrossDatabase ()
    {
        ...
        $this->skipIf(
                !isset($config['test']) || !isset($config['test2']), 'Primary and secondary test databases not configured, ' .
