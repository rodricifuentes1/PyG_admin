...
class ModelIntegrationTest extends BaseModelTest
{
    ...
    public function testHABTMKeepExistingWithThreeDbs ()
    {
        ...
        $this->skipIf(
                !isset($config['test']) || !isset($config['test2']) || !isset($config['test_database_three']), 'Primary, secondary, and tertiary test databases not configured, skipping test. To run this test define $test, $test2, and $test_database_three in your database configuration.'
        );
