...
class PaginatorComponentTest extends CakeTestCase
{
    ...
    public function testPaginateSpecialType ()
    {
        ...
        $this->assertEquals(array (2, 3), Hash::extract($result, '{n}.PaginatorControllerPost.id'));
        $this->assertEquals(
                $Controller->PaginatorControllerPost->lastQueries[1]['conditions'], array ('PaginatorControllerPost.id > ' => '1')
        );
    ...
    public function testPaginateOrderModelDefault ()
    {
        ...
        $this->assertEquals(
                $Controller->PaginatorControllerPost->order, $Controller->request->paging['PaginatorControllerPost']['options']['order']
        );
    ...
    public function testOutOfRangePageNumberAndPageCountZero ()
    {
        ...
        {
            $this->assertEquals(
                    1, $Controller->request->params['paging']['PaginatorControllerPost']['page'], 'Page number should not be 0'
            );
        }
    }
    ...
    public function testPaginateOrderVirtualFieldSharedWithRealField ()
    {
        ...
        $result = Hash::extract(
                        $Controller->paginate('PaginatorControllerComment'), '{n}.PaginatorControllerComment.id'
        );
