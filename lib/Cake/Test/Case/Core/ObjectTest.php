...
class ObjectTest extends CakeTestCase
{
    ...
    public function testRequestActionArray ()
    {
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'another_ra_test'), array ('pass' => array ('5', '7'))
        );
        $expected = 12;
        $this->assertEquals($expected, $result);
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'paginate_request_action'), array ('pass' => array (5), 'named' => array ('param' => 'value'))
        );
        $this->assertTrue($result);
    }
    ...
    public function testRequestActionParamParseAndPass ()
    {
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'params_pass'), array ('named' => array ('sort' => 'desc', 'limit' => 5))
        );
        $this->assertEquals($expected, $result['named']);
    }
    ...
    public function testRequestActionGetParameters ()
    {
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'params_pass'), array ('url' => array ('get' => 'value', 'limit' => 5))
        );
        $this->assertEquals('value', $result->query['get']);
    }
    ...
    public function testRequestActionNoPostPassing ()
    {
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'post_pass'), array ('data' => $_POST['data'])
        );
        $expected = $_POST['data'];
        $this->assertEquals($expected, $result);
    ...
    public function testRequestActionPostWithData ()
    {
        ...
        $result = $this->object->requestAction(
                array ('controller' => 'request_action', 'action' => 'post_pass'), array ('data' => $data)
        );
        $this->assertEquals($data, $result);

        $result = $this->object->requestAction(
                '/request_action/post_pass', array ('data' => $data)
        );
        $this->assertEquals($data, $result);
    }
