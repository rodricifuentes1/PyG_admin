...
class Permission extends AppModel
{
    ...
    public function check ($aro, $aco, $action = '*')
    {
        ...
        if (!$aroPath || !$acoPath)
        {
            trigger_error(__d('cake_dev', "%s - Failed ARO/ACO node lookup in permissions check. Node references:\nAro: %s\nAco: %s", 'DbAcl::check()', print_r($aro, true), print_r($aco, true)), E_USER_WARNING
            );
            return false;
        }
        ...
        if (!$acoPath)
        {
            trigger_error(__d('cake_dev', "%s - Failed ACO node lookup in permissions check. Node references:\nAro: %s\nAco: %s", 'DbAcl::check()', print_r($aro, true), print_r($aco, true)), E_USER_WARNING
            );
            return false;
        }
