...
class CakePlugin
{
    ...
    public static function bootstrap ($plugin)
    {
        ...
        if ($config['bootstrap'] === true)
        {
            return self::_includeFile(
                            $path . 'Config' . DS . 'bootstrap.php', $config['ignoreMissing']
            );
        }
        ...
        {
            self::_includeFile(
                    $path . 'Config' . DS . $file . '.php', $config['ignoreMissing']
            );
        }
    ...
    public static function routes ($plugin = null)
    {
        ...
        return (bool) self::_includeFile(
                        self::path($plugin) . 'Config' . DS . 'routes.php', $config['ignoreMissing']
        );
    }
